...
public class StoneAI_eval extends AI
{
    ...
    )
    {
        ...
        //         clientSocket.connect(new InetSocketAddress("140.122.184.89", 7001), 1000);
        ...
        while(done==0){
            try {
                Socket clientSocket = new Socket();
                clientSocket.connect(new InetSocketAddress("140.122.184.66", 7001), 1000);
                PrintStream out = new PrintStream(clientSocket.getOutputStream());  
                System.out.println("Send.");
